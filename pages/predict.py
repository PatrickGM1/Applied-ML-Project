...
st.markdown(
    ...
    <div style="margin-bottom: 0.3rem;">
        <h2 style="margin-bottom: 0.1rem;">Base Model</h2>
        <span style="color:#666; font-size:0.82rem;">TF-IDF + Logistic Regression &middot; text + metadata + speaker history</span>
    </div>
    """,
...
with st.form("predict_form"):
    ...
    with st.expander("Speaker history — prior label counts"):
